...
export const projects: Project[] = [
    {
        ...
        title: "RXWM",
        description:
            "A streamlined and efficient dynamic window manager forked from DWM. Built with C and Xlib, providing deep customization, smooth keybindings, and a polished interface for minimal desktop environments.",
        images: [
    ...
    },
    {
        ...
        title: "EternaLink",
        description:
            "A cross-platform mobile application for real-time voice AI calling. Built with React Native & Expo, featuring on-device speech-to-text, low-latency streaming responses, and voice-cloned synthesis via ElevenLabs.",
        images: [
        ...
        links: [
            ...
            },
            {
                ...
                name: "Google Play",
                url: "https://play.google.com/store/apps/details?id=com.eternalink",
            },
            {
                icon: "mdi:github",
                name: "GitHub",
